...
export declare namespace CalendarEvent {
    interface Attendees {
 ...
 */
export declare var DocumentPicker: {
    /**
     * _Opens a document._
     *
...
export declare namespace FileManager {
...
export declare namespace RecurrenceRule {
    /**
 ...
 * _Logs a warning message to the console._
 */
export declare function logWarning(message: any): void;
